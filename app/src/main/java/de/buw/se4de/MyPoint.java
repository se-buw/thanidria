...
public class MyPoint {
    ...
    public void roundPoint(MyPoint b, int roundingLimit) {   // compares new point to former point in list to see if the same point is intended to be created
    ...
    public void setY(MyPoint b) {   // rounds only y coordinate
        b.yCoordinate = this.yCoordinate;
    }
}
